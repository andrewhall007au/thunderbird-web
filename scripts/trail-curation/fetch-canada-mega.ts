// Fetch Canadian mega thru-hikes using known OSM relation IDs
// Based on fetch-us-mega.ts
// Usage: npx tsx scripts/trail-curation/fetch-canada-mega.ts [--trail NAME] [--skip-elevation]
...
const MEGA_TRAILS: MegaTrail[] = [
  { name: 'Sentier International des Appalaches', id: 'sentier_international_des_appalaches', osmRelationId: 9318808, officialDistanceKm: 650, region: 'Quebec', typicalDays: '40' },
  { name: 'Great Divide Trail', id: 'great_divide_trail', osmRelationId: 8139599, officialDistanceKm: 1200, region: 'British Columbia / Alberta', typicalDays: '60' },
];
...
async function main() {
  ...
  console.log('=== FETCH CANADA MEGA THRU-HIKES ===');
