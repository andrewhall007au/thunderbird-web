    ...
    <div className="min-h-screen bg-white text-gray-900">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            href="/create"
            className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-gray-900 rounded-lg hover:bg-blue-500 transition-colors"
          >
        ...
        {routes.length === 0 ? (
          <div className="text-center py-12 bg-gray-50 rounded-lg">
            ...
            <h2 className="text-xl font-semibold text-gray-700 mb-2">No routes yet</h2>
            <p className="text-gray-500 mb-6">Create your first route to get started</p>
            <Link
              href="/create"
              className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 text-gray-900 rounded-lg hover:bg-blue-500 transition-colors"
            >
              <Plus className="w-5 h-5" />
              Create Route
            </Link>
