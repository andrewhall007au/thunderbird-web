    ...
    <div className="bg-zinc-800 border-t border-zinc-700">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          {enabled && !isExpanded && (
            <div className="px-2 py-0.5 bg-blue-600 rounded text-xs font-medium">
        ...
        <div className="px-4 pb-4 space-y-4 border-t border-zinc-700 pt-4">
          ...
          <div className="pt-2 border-t border-zinc-700">
            ...
            <div className="text-sm font-medium">
              {enabled ? (
                <span className="text-blue-400">📡 Satellite Data ({(latencyMs / 1000).toFixed(1)}s latency)</span>
              ) : (
                <span className="text-green-400">🌐 Full Connectivity</span>
              )}
            </div>
          </div>
          ...
          <div className="bg-zinc-900 rounded p-3 text-xs text-zinc-400">
            <div className="font-medium text-zinc-300 mb-1">About This Simulation</div>
            <p>
