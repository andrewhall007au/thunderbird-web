...
const trailheads: [string, number, number][] = [
  ...
  ['ben_macdui_from_cairn_gorm', 57.029, -3.627],
  ...
  ['half_dome_via_mist_trail', 37.745, -119.513],
  ...
  ['mount_maria_walk', -42.607, 148.068],
  ...
  ['mount_washington_via_tuckerman_ravine', 44.258, -71.253],
  ...
  ['point_lesueur_walk', 48.709, 5.797],
  ...
  ['sentinel_dome_and_taft_point', 37.713, -119.587],
  ['sentinel_pass_trail', 51.326, -116.19],
  ['six_foot_track', -33.704, 150.289],
  ['skye_trail', 57.187, -6.097],
