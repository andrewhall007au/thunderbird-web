...
export default function PreviewContent() {
  ...
  return (
    <div className="h-full bg-zinc-900 overflow-auto">
      {/* Tab Header */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-zinc-800 border-b border-zinc-700">
      ...
      {/* Current dimensions */}
      <div className="fixed bottom-4 left-1/2 -translate-x-1/2 bg-zinc-800 text-zinc-400 px-4 py-2 rounded-full text-sm">
