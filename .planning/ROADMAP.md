...
**Goal:** Replace simplified trail coordinate data with real GPX-quality trail data from non-proprietary sources. Expand trail library to ~250+ unique deduplicated trails covering launch markets (US, Canada, Australia) and top global trails. Trails grouped by country in the UI.
...
- Top 25 trails in Canada (launch market)
...
- Top 100 trails globally (deduplicated against US/Canada/Australia)
- Expected total: ~250+ unique trails
...
Plans:
- [ ] 10-01-PLAN.md — Trail curation pipeline (Overpass API scripts, simplification, validation, batch processing)
- [ ] 10-02-PLAN.md — UI country grouping (TrailSelector with country headers and "Coming Soon")
- [ ] 10-03-PLAN.md — US trails (100 trails, fetched and validated from OSM)
- [ ] 10-04-PLAN.md — Canada + Australia trails (25 CA + 50 AU including 25 Tasmania)
- [ ] 10-05-PLAN.md — Global trails (100 trails across JP, NZ, GB, FR, CH, IT, ZA, DE)
- [ ] 10-06-PLAN.md — Final integration (merge results, generate popularTrails.ts, resolve failures)
- [ ] 10-07-PLAN.md — Validation and sign-off (distance report, visual QA, user approval)
